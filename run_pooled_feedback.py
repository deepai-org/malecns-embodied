...
desired movement. All selected muscle units receive only the supplied named-pool MN rates.
"""
import argparse
import hashlib
import json
...
def main():
    ...
    receipt = dict(completed=True, kind='exploratory fixed-base muscle feedback loop',
        ...
        assumptions=['SNpp50/51 opponent clipped-linear position currents; both polarity hypotheses retained.',
                     ...
                     'Equal mean normalized MN rates follow the supplied mapping; subdivision sharing is uncalibrated.',
